...
namespace CRPG
{
    ...
    {
        public static readonly string WorldName = "Anndorous";
        ...
        static World()
        { //must call each of these 4 methods in this order
            PopulateItems();
            PopulateMonsters();
            PopulateQuests();
            PopulateLocations();
...
//==============================================================================================================================
        ...
        {                 //listed as: ID, name, maxDmg, XPpoints, gold, currentHP, maxHP
            Monster rat = new Monster(MONSTER_ID_RAT, "Rat", 5, 3, 10, 3, 3);
            rat.LootTable.Add(new LootItem(ItemByID(ITEM_ID_RAT_TAIL), 75, false)); //75% chance of dropping 
            rat.LootTable.Add(new LootItem(ItemByID(ITEM_ID_PIECE_OF_FUR), 75, true)); //75% chance of dropping
...
//==============================================================================================================================
        private static void PopulateQuests()
        {
            ...
            //must have 3 snake fangs to complete
            clearFarmersField.QuestCompletionItems.Add(new QuestCompletionItem(ItemByID(ITEM_ID_SNAKE_FANG), 3));
            //once complete. you will receive vvv (adventurer pass)
